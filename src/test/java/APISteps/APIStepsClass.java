...
public class APIStepsClass {
    ...
    public void aJWTBearerTokenIsGenerated() {
        request = given().
                header(APIConstants.HEADER_AUTHORIZATION_KEY, APIConstants.HEADER_CONTENT_TYPE_VALUE).
                body("{\n" +
                        "  \"email\": \"anaBanana19@yahoo.com\",\n" +
    ...
    public void theEmployeeIdIsStoredAsAGlobalVariable(String empIdPath) {
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    @Then("the received data from {string} object matches with the data we used to create the employee")
    public void the_received_data_from_object_matches_with_the_data_we_used_to_create_the_employee(
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    public void a_request_is_prepared_for_creating_an_employee_using_json_payload_dynamic(String fn, String ln,
